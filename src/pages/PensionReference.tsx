...
import { Accordion, Badge, Card, Col, Container, Navbar, Row, Table } from "react-bootstrap";
    ...
    <>
        ...
        <Container>
          ...
          <Navbar.Text className="fw-semibold" style={{ color: "var(--bt-text)" }}>
            <i
              ...
              style={{ color: "var(--bt-be-light)" }}
            />
            Naslagwerk Pensioen
          </Navbar.Text>
          <Link to="/naslagwerk" style={{ textDecoration: "none" }} className="ms-3">
      ...
      <Container fluid="lg" className="pb-5">
        ...
        <div className="text-center mb-5 mt-2">
          ...
          >
            🇧🇪&thinsp;🇳🇱&nbsp; Pensioen als Grensarbeider
          </h1>
          <p style={{ color: "var(--bt-text-sub)", maxWidth: 640, margin: "0 auto" }}>
            Referentiegids over AOW, ANW, aanvullend pensioen (NL) en Belgisch rustpensioen
            voor wie in België woont en in Nederland werkt.
            Gebaseerd op ACV Infosessie 24 maart 2026 (Pelt).
          </p>
        </div>

        {/* ── 3-pijler overzicht ────────────────────────────────── */}
        <SectionCard title="De 3 pijlers" icon="bi-layers-fill" accent="neutral">
          <Row className="g-3">
            {[
              {
                pijler: "1e pijler",
          ...
          <WarnBox>
            <strong>Begripsverwarring:</strong> "Pensioen" in Nederland = aanvullend op
            AOW (2e pijler). "Pensioen" in België = het wettelijk pensioen. Niet
            verwarren bij gesprekken met HR of pensioenfondsen.
          </WarnBox>
        </SectionCard>
        ...
        <Row className="g-4">
          <Col lg={6}>
            {/* ── AOW ────────────────────────────────────────────── */}
            <SectionCard title="Pijler 1 — AOW (Nederland)" icon="bi-flag-fill" accent="nl">
              <StatRow label="Opbouw per verzekerd jaar" value="2%" />
              <StatRow label="Volledige AOW" value="50 jaar = 100%" />
              <StatRow label="Premie 2026" value="17,9%" sub="over max €38.883, vervat in loonheffing" />
              ...
              <div className="mt-4 mb-2 small fw-semibold" style={{ color: "var(--bt-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                Maximumbedragen per 1 januari 2026
              </div>
              <Table size="sm" style={{ fontSize: "0.8rem", color: "var(--bt-text)" }}>
                ...
                <tbody>
                  <tr style={{ borderColor: "var(--bt-border)" }}>
                    ...
                    <td style={{ fontFamily: "var(--bt-font-mono)", color: "var(--bt-nl-light)" }}>70%</td>
                  ...
                  <tr style={{ borderColor: "var(--bt-border)" }}>
                    ...
                    <td style={{ fontFamily: "var(--bt-font-mono)", color: "var(--bt-nl-light)" }}>50%</td>
              ...
              <div className="mt-3 p-3 rounded" style={{ background: "var(--bt-surface-3)", border: "1px solid var(--bt-border)" }}>
                <div className="small fw-semibold mb-2" style={{ color: "var(--bt-text-muted)" }}>
                  Voorbeeld: 30 jaar grensarbeid
                </div>
              ...
              <div className="mt-3">
                <TipBox>
                  <strong>Partner meeverzekeren:</strong> Echtgeno(o)t(e) zonder inkomen
                  bouwt mee AOW op — aanmelden bij SVB <strong>binnen het jaar</strong>{" "}
                  na aanvang arbeid in Nederland.
                </TipBox>
                <TipBox>
                  AOW aanvragen: via gemeente → FPD → SVB, of via{" "}
                  <strong>pensioenaanvraag.be</strong> of tel. 1765.{" "}
                  Uiterlijk <strong>8 maanden</strong> voor ingangsdatum.
                  Tijdvakken controleren op <strong>mijnsvb.nl</strong> (DigiD of Belgische eID).
                </TipBox>
              </div>
              ...
              <Accordion flush className="mt-2">
                ...
                >
                  <Accordion.Header>
                    <span className="small fw-semibold">Historiek AOW-leeftijden</span>
                  </Accordion.Header>
            ...
            {/* ── ANW ────────────────────────────────────────────── */}
            <SectionCard title="Pijler 1 — ANW (overlijden NL)" icon="bi-heart-pulse-fill" accent="nl">
              <StatRow label="Uitkering bruto/mnd" value="€1.668,49" sub="70% netto minimumloon" />
              <StatRow label="Vakantiegeld" value="€128,18/mnd" />
              <StatRow
                label="Voorwaarden"
                value="< AOW-leeftijd + kind < 18j of ≥ 45% AO"
              />
              <StatRow label="Wezenuitkering" value="kind < 21 jaar" sub="bij overlijden beide ouders" />

              <div className="mt-3 small fw-semibold mb-2" style={{ color: "var(--bt-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                Bijverdienen naast ANW
              </div>
              ...
              <StatRow label="Geen ANW bij uitkeringen >" value="€1.646/mnd" sub="WW, ZW, buitenlands pensioen enz." />

              <WarnBox>
                ANW eindigt bij samenwonen met een partner of als niet meer voldaan
                wordt aan de basisvoorwaarden (bijv. kind wordt 18).
              </WarnBox>
            </SectionCard>

            {/* ── Bijverdienen bij AOW ───────────────────────────── */}
            <SectionCard title="AOW & Bijverdienen — Aandachtspunten" icon="bi-exclamation-diamond-fill" accent="nl">
              <WarnBox>
                <strong>Knipperlichtsituatie:</strong> wie AOW + Belgisch pensioen + NL
                2e pijlerpensioen ontvangt én gaat bijverdienen in Nederland, wordt
                opnieuw <strong>ziekenfondsverzekerde in NL</strong>. Gevolg:
              </WarnBox>
              <ul className="small mb-0" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
          ...
          <Col lg={6}>
            ...
            <SectionCard
              title="Pijler 2 — Aanvullend pensioen (Nederland)"
              icon="bi-building-fill"
              accent="nl"
            >
              <p className="small mb-3" style={{ color: "var(--bt-text-sub)" }}>
                Nederland verkozen tot{" "}
                <strong style={{ color: "var(--bt-nl-light)" }}>beste pensioenstelsel ter wereld</strong>{" "}
              ...
              <StatRow
                label="Afkoop mogelijk als pensioen <"
                value="€632/jaar"
              />
              <StatRow label="Partnerpensioen" value="70% van ouderdomspensioen" sub="kan worden uitgeruild" />
              <StatRow label="UPO (pensioenoverzicht)" value="jaarlijks" sub="aanvragen bij uitvoerder, ≥ 4 mnd op voorhand" />

              <TipBox>
                Pensioenopbouw raadplegen op{" "}
                <strong>mijnpensioenoverzicht.nl</strong> (DigiD of Belgische eID / Itsme).
                Oudere BSN? Laat sofinummer omzetten.
              </TipBox>

              <div className="mt-2 mb-2 small fw-semibold" style={{ color: "var(--bt-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                Wet Toekomst Pensioenen (WTP) — hervorming uiterlijk 1/1/2028
              </div>
              <ul className="small mb-3" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
                <li>Eindloon- en middelloonregelingen worden afgeschaft</li>
                <li>Alle regelingen worden <strong>premieregelingen</strong></li>
                <li>Gelijke, leeftijdsonafhankelijke premie voor iedereen</li>
                <li>Partnerpensioen als vast percentage verzekerd</li>
                <li>10% van de waarde kan als <strong>bedrag ineens</strong> opgenomen worden</li>
              </ul>
              ...
              <p className="small mb-1" style={{ color: "var(--bt-text-sub)" }}>
                Wet verevening pensioen bij scheiding: ex-partner heeft wettelijk recht
                op de helft van het opgebouwde pensioen tijdens het huwelijk.
              </p>
              <WarnBox>
                Doorgeven aan pensioenuitvoerder binnen <strong>2 jaar</strong> via
                "Mededelingsformulier verdeling ouderdomspensioen bij echtscheiding".
                Niet doorgeven = aanspraak ex-partner blijft bestaan!
              </WarnBox>
            </SectionCard>

            {/* ── RVU ────────────────────────────────────────────── */}
            <SectionCard
              title="RVU — Vervroegde Uittreding"
            ...
            >
              ...
              <ul className="small mt-3 mb-0" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
                <li>Werknemer neemt zelf ontslag → <strong>geen recht op WW</strong></li>
              ...
              <TipBox>
                <strong>Belasting RVU:</strong> belastbaar in België (woonland), tenzij
                je ambtenaar bent geweest met NL nationaliteit. Niet vergeten:
                vrijstelling loonbelasting aanvragen!
              </TipBox>
            </SectionCard>

            {/* ── Inhoudingen op pensioen ────────────────────────── */}
            <SectionCard
              title="Inhoudingen op AOW/Pensioen (postactief)"
            ...
            >
              ...
              <StatRow
                label="Inkomensafh. bijdrage ZVW"
                value="4,85%"
                sub="over max €79.409"
              />
              ...
              <TipBox>
                Recht op zorg in zowel Nederland als België blijft behouden.
              </TipBox>
            </SectionCard>
          </Col>
        </Row>
        ...
        <SectionCard
          title="Belgisch Rustpensioen 2026"
          icon="bi-flag-fill"
          accent="be"
        >
          <Row className="g-4">
            <Col md={4}>
              <div className="small fw-semibold mb-2" style={{ color: "var(--bt-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                Basisparameters
              </div>
              <StatRow label="Wettelijke pensioenleeftijd" value="66 jaar" sub="vanaf 2030: 67 jaar" highlight />
              <StatRow label="Volledige loopbaan" value="14.040 dagen" sub="104 dagen = 1 loopbaanjaar" />
              ...
              <WarnBox>
                Geen automatisch onderzoek bij einde loopbaan in Nederland. Aanvraag
                doen is verplicht als je vóór 66 jaar wil gaan.
              </WarnBox>
            </Col>

            <Col md={4}>
              <div className="small fw-semibold mb-2" style={{ color: "var(--bt-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                Vroegst mogelijke ingangsdatum 2026
              </div>
              <Table size="sm" style={{ fontSize: "0.8rem", color: "var(--bt-text)" }}>
                <thead style={{ background: "var(--bt-surface-3)" }}>
                  <tr>
                    <th>Leeftijd</th>
                    <th>Vereiste loopbaan</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={age} style={{ borderColor: "var(--bt-border)" }}>
                      <td style={{ fontFamily: "var(--bt-font-mono)", color: "var(--bt-be-light)" }}>
                        {age}
                      </td>
            ...
            <Col md={4}>
              <div className="small fw-semibold mb-2" style={{ color: "var(--bt-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                ZIV-inhouding op Belgisch pensioen
              </div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={range} style={{ borderColor: "var(--bt-border)" }}>
                      <td style={{ fontFamily: "var(--bt-font-mono)", fontSize: "0.75rem", color: "var(--bt-be-light)" }}>
                        {range}
                      </td>
              ...
              <WarnBox>
                AOW + Belgisch pensioen worden <strong>samengeteld</strong> voor de
                ZIV-drempel. Ook solidariteitsbijdrage: 0,5–2% bij pensioen &gt;{" "}
                €3.682 (alleenstaand) / €4.212 (gezin).
              </WarnBox>
            </Col>
          </Row>
        </SectionCard>
        ...
        <Row className="g-4">
          <Col md={4}>
            <SectionCard
              title="Belgisch Pensioen 2027 — Nieuwe Regels"
              icon="bi-calendar-check-fill"
              accent="be"
            >
              <p className="small mb-3" style={{ color: "var(--bt-text-sub)" }}>
                Loopbaaneis per jaar stijgt van{" "}
                <strong>104 → 156 effectieve werkdagen</strong> (uitzondering: 1e
                loopbaanjaar + 5 reservedagen).
              </p>
              <Table size="sm" style={{ fontSize: "0.8rem", color: "var(--bt-text)" }}>
                <thead style={{ background: "var(--bt-surface-3)" }}>
                  <tr>
                    <th>Leeftijd</th>
                    <th>Loopbaan (156 dgn/jr)</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                  ...
                  ].map((row) => { const [age, career] = row; return (
                    <tr key={String(age) + String(career)} style={{ borderColor: "var(--bt-border)" }}>
                      <td style={{ fontFamily: "var(--bt-font-mono)", color: "var(--bt-be-light)" }}>
                        {age}
                      </td>
                      <td style={{ color: "var(--bt-text-sub)" }}>{career}</td>
          ...
          <Col md={4}>
            <SectionCard title="Pensioenmalus 2027" icon="bi-arrow-down-circle-fill" accent="be">
              <p className="small mb-3" style={{ color: "var(--bt-text-sub)" }}>
                Van toepassing als <strong>niet voldaan</strong> aan: 35 jaar ×
                minstens 156 dagen + totaal 7.020 gepresteerde/gelijkgestelde dagen.
              </p>
              <Table size="sm" style={{ fontSize: "0.85rem", color: "var(--bt-text)" }}>
                <thead style={{ background: "var(--bt-surface-3)" }}>
                  <tr>
                    <th>Geboortejaar</th>
                    <th>Malus per vervroegd jaar</th>
                  </tr>
                </thead>
                <tbody>
                  {[
          ...
          <Col md={4}>
            <SectionCard title="Pensioenbonus 2027" icon="bi-arrow-up-circle-fill" accent="be">
              <p className="small mb-3" style={{ color: "var(--bt-text-sub)" }}>
                Voor wie <strong>langer werkt</strong> dan wettelijke pensioenleeftijd.
                Vereist: loopbaan ≥ 35 jaar + 7.020 dagen.
              </p>
              <Table size="sm" style={{ fontSize: "0.85rem", color: "var(--bt-text)" }}>
                <thead style={{ background: "var(--bt-surface-3)" }}>
                  <tr>
                    <th>Geboortejaar</th>
                    <th>Bonus per extra jaar</th>
                  </tr>
                </thead>
                <tbody>
                  {[
        ...
        <Row className="g-4">
          <Col md={6}>
            <SectionCard
              title="Inkomenshiaat — Uiteenlopende Pensioenleeftijden"
            ...
            >
              ...
              <ul className="small mb-3" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
                <li>Belgische pensioenleeftijd: <strong>66 jaar</strong> (2026), maar AOW-leeftijd: <strong>67 jaar</strong></li>
              ...
              <div className="small fw-semibold mb-2" style={{ color: "var(--bt-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                Oplossing: Art. 64 werkloosheidsreglementering
              </div>
              <p className="small mb-2" style={{ color: "var(--bt-text-sub)" }}>
                Werkloosheidsuitkering kan doorlopen tot AOW-leeftijd als:
              </p>
              <ol className="small mb-0" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
                <li>Minstens <strong>15 jaar grensarbeid</strong> bewezen</li>
                <li>Géén pensioen ontvangen: tijdelijk afzien van Belgisch rustpensioen <em>én</em> 2e pijlerpensioen niet laten ingaan</li>
              </ol>
              <WarnBox>
                Regeling dekt niet alle gevallen: wie geen 15 jaar grensarbeid bewijst,
                of wiens 2e pijlerpensioen niet uitgesteld kan worden, valt buiten de
                regeling.
              </WarnBox>
            </SectionCard>
          </Col>
          ...
          <Col md={6}>
            <SectionCard
              title="Grensarbeiderspensioen — Wat Rest er?"
              icon="bi-archive-fill"
              accent="be"
            >
              <p className="small mb-3" style={{ color: "var(--bt-text-sub)" }}>
                Het "grensarbeiderspensioen" berekende een Belgisch pensioen alsof men
                in België had gewerkt en paste het verschil bij. Inmiddels sterk
                ingeperkt:
              </p>
              <ul className="small mb-3" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
                <li>
                  <strong>Geen nieuwe instroom</strong> meer voor grensarbeiders die
                  na <strong>1 januari 2015</strong> voor het eerst grensarbeider worden
                </li>
                <li>
                  Vervroegde ingangsdatum niet meer mogelijk — onderzoek gelijk met
                  wettelijke pensioenleeftijd werkland
                </li>
                <li>
                ...
                <li>
                  Overlevingspensioen t.l.v. BE blijft, maar ook met aftrek ANW en
                  2e pijlerpensioen
                </li>
                <li>
              ...
              <TipBox>
                Begon je met grensarbeid vóór 1/1/2015? Controleer bij FPD of je
                rechten op het grensarbeiderspensioen behouden zijn.
              </TipBox>
            </SectionCard>
          </Col>
        </Row>
        ...
        <SectionCard
          title="Overlevingspensioen België 2026"
          icon="bi-heart-fill"
          accent="be"
        >
          <Row className="g-3">
            <Col md={6}>
              ...
              <ul className="small" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
                <li>Rechthebbende in 2026: minstens <strong>51 jaar</strong></li>
                <li>Minstens <strong>1 jaar gehuwd</strong></li>
                <li>Automatische berekening als overledene al met pensioen was</li>
                <li>Zo niet: aanvraag doen</li>
                <li>Recht vervalt bij <strong>nieuw huwelijk</strong></li>
            ...
            <Col md={6}>
              ...
              <ul className="small mb-0" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
                ...
                <li>
                  Gedurende max <strong>12 maanden</strong>: combinatie met
                  vervangingsinkomen mogelijk
                </li>
              </ul>
            </Col>
          </Row>
        ...
        <SectionCard
          title="Arbeidsongeschiktheid & AOW-opbouw"
        ...
        >
          <Row className="g-3">
            <Col md={6}>
              <p className="small mb-2" style={{ color: "var(--bt-text-sub)" }}>
                Bij <strong>WAO/WIA uitkering</strong>: niet meer automatisch verzekerd
                voor ouderdom &amp; overlijden.
              </p>
              <ul className="small" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
                <li>
                ...
                <li>
                  Of: <strong>regularisatiebijdragen</strong> betalen aan Federale
                  Pensioendienst (BE) — af te sluiten <strong>binnen 3 jaar</strong>
                </li>
              </ul>
            </Col>
            <Col md={6}>
        ...
        <SectionCard
          title="Belasting op Pensioen — Waar?"
        ...
        >
          ...
          <Row className="g-3">
            <Col md={6}>
              <div className="small fw-semibold mb-2" style={{ color: "var(--bt-text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                Uitzondering: belastbaar in Nederland
              </div>
              <ul className="small mb-0" style={{ color: "var(--bt-text-sub)", paddingLeft: "1.2rem" }}>
            ...
            <Col md={6}>
              <TipBox>
                <strong>RVU:</strong> belastbaar in België tenzij ambtenaar met NL
                nationaliteit. In aangifte op te geven als "opzegvergoeding".
                Vrijstelling loonbelasting niet vergeten aan te vragen!
              </TipBox>
              <TipBox>
                <strong>AOW altijd belastbaar in België</strong> (woonland).
                2e pijlerpensioen ook, tenzij ambtenaar met uitsluitend NL nationaliteit.
              </TipBox>
            </Col>
          </Row>
        </SectionCard>
        ...
        {/* ── Bronbestand ─────────────────────────────────────────── */}
        <SectionCard title="Bronbestand" icon="bi-file-earmark-pdf-fill" accent="neutral">
          <a
        ...
        >
          Gebaseerd op ACV Grensarbeiders Infosessie 24 maart 2026 (Pelt). Geen rechten
          te ontlenen. Raadpleeg ACV Grensarbeiders of een pensioenspecialist.&nbsp;|&nbsp;
          <a
